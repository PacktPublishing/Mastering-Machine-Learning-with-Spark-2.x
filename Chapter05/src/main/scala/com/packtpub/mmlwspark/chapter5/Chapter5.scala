package com.packtpub.mmlwspark.chapter5
...
/**
  * Mastering Machine Learning With Spark: Chapter 5
  */
object Chapter5 extends App {
  ...
  val spark = SparkSession.builder()
     .master("local[*]")
     .appName("Mastering Machine Learning with Spark: Chapter5")
  ...
  def script(spark: SparkSession): Unit = {
    // @Script START
    // @Snippet
