...
gbmStrategy.numIterations = 10
gbmStrategy.treeStrategy.numClasses = 2
gbmStrategy.treeStrategy.maxDepth = 10
gbmStrategy.learningRate = 0.1
gbmStrategy.treeStrategy.categoricalFeaturesInfo = Map[Int, Int]()
